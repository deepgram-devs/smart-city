...
def build_settings() -> dict:
    ...
    if hotword:
        system_prompt += (
            ...
            f"- If check_hotword returns {{\"active\": false}}: You MUST respond with ONLY an empty string. Zero tokens. No words at all. Do NOT repeat your greeting. Do NOT say 'Systems online' or re-introduce yourself. Do NOT say 'silent mode'. Produce literally nothing.\n"
